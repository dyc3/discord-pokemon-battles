...
async def agent_dumb():
	return Response('{"type": 0, "args": {"target": {"party":0, "slot": 0}, "move": 0}}',
...
async def test():
	start = {
		"Parties": [[{
			...
			0,
			"IVs": [4, 3, 1, 3, 4, 4],
			"EVs": [13, 39, 27, 7, 33, 21],
			"Nature":
			14,
			"Stats": [200, 167, 73, 137, 76, 98],
			"StatModifiers": [0, 0, 0, 0, 0, 0, 0, 0, 0],
			"StatusEffects":
			0,
			"CurrentHP":
		...
		"CallbackUrls": ["http://bot:5000/agent/dumb", "http://bot:5000/agent/dumb"]
	}
